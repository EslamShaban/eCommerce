...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">{{trans('admin.malls')}}</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <a href="{{route('malls.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> <span>{{trans('admin.create_new_mall')}}</span></a>
      ...
      <form action="{{aurl('malls/destroy/all')}}" id="form_data" >
        ...
        <table id="example1" class="table table-bordered table-striped table-responsive">
          ...
          <tr>
            ...
            <th>#</th>
            <th>{{trans('admin.mallname_ar')}}</th>
            <th>{{trans('admin.mallname_en')}}</th>
          ...
          <tbody>
              ...
              @foreach($malls as $mall)
                  ...
                  <tr style="height:10px">
                    <td><input type="checkbox" class="item_checkbox" name="item[]" onclick="item_check('{{$malls->count()}}')" value="{{$mall->id}}" /></td>
                    <td>{{$i}}</td>
                    <td>{{$mall->mallname_ar}}</td>
                    <td>{{$mall->mallname_en}}</td>
                    ...
                    <td>
                      <a href="{{route('malls.edit', $mall->id)}}" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                      <a href="#" class="btn btn-danger" onclick="delete_this_item('{{$mall->id}}')"><i class="fa fa-trash"></i> </a>
                    </td>
                  </tr>
              @endforeach
