    ...
    <div class="card-body">
        <form action="settings" method="post">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text"  name="sitename_ar" id="sitename_ar" class="form-control" value="{{old('sitename_ar')}}" placeholder="{{trans('admin.sitename_ar')}}">
            </div>
            <div class="form-group mb-3">
              <label for="sitename_en" >{{trans('admin.sitename_en')}}</label>
              <input type="text"  name="sitename_en" id="sitename_en" class="form-control" value="{{old('sitename_en')}}" placeholder="{{trans('admin.sitename_en')}}">
            </div>
            <div class="form-group mb-3">
              <label for="icon" >{{trans('admin.icon')}}</label>
              <input type="file"  name="icon" id="icon" class="form-control" value="{{old('icon')}}" placeholder="{{trans('admin.icon')}}">
            </div>
            <div class="form-group mb-3">
              <label for="logo" >{{trans('admin.logo')}}</label>
              <input type="file"  name="logo" id="logo" class="form-control" value="{{old('logo')}}" placeholder="{{trans('admin.logo')}}">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <textarea rows='5' name="message_maintenance" id="message_maintenance" class="form-control" value="{{old('message_maintenance')}}" placeholder="{{trans('admin.message_maintenance')}}"></textarea>
            </div>
            <div class="col-3">
