    ...
    <div class="card-body">
        ...
        <form action="{{route('admin.update', $admin->id)}}" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text"  name="name" id="name" class="form-control" value="{{$admin->name}}" placeholder="{{trans('admin.name')}}">
            </div>
            <div class="form-group mb-3">
                <label for="email">{{trans('admin.email')}}</label>
                <input type="email"  name="email" id="email" class="form-control" value="{{$admin->email}}" placeholder="{{trans('admin.email')}}">
              </div>
            <div class="form-group mb-3">
