...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">{{trans('admin.admin')}}</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <a href="{{route('admin.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> <span>{{trans('admin.create_new_admin')}}</span></a>
      ...
      <form action="{{aurl('admin/destroy/all')}}" id="form_data" >
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
              ...
              @foreach($admins as $admin)
                ...
                @endphp
                <tr>
                  <td><input type="checkbox" class="item_checkbox" name="item[]" onclick="item_check('{{$admins->count()}}')" value="{{$admin->id}}" /></td>
                  <td>{{$i}}</td>
                  <td>{{$admin->name}}</td>
                  <td>{{$admin->email}}</td>
                  ...
                  <td>
                    <a href="{{route('admin.edit', $admin->id)}}" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <a href="#" class="btn btn-danger" onclick="delete_this_item('{{$admin->id}}')"><i class="fa fa-trash"></i> </a>
