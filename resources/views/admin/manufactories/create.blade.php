...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">{{trans('admin.create_new_manufactory')}}</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <form action="{{route('manufactories.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text"  name="manufactoryname_ar" id="manufactoryname_ar" class="form-control" value="{{old('manufactoryname_ar')}}" placeholder="{{trans('admin.manufactoryname_ar')}}">
            </div>
            <div class="form-group mb-3">
              <label for="manufactoryname_en">{{trans('admin.manufactoryname_en')}}</label>
              <input type="text"  name="manufactoryname_en" id="manufactoryname_en" class="form-control" value="{{old('manufactoryname_en')}}" placeholder="{{trans('admin.manufactoryname_en')}}">
            </div>
            <div class="form-group mb-3">
              <label for="contact_name">{{trans('admin.contact_name')}}</label>
              <input type="text"  name="contact_name" id="contact_name" class="form-control" value="{{old('contact_name')}}" placeholder="{{trans('admin.contact_name')}}">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input type="file"  name="logo" id="logo" class="form-control image" value="" placeholder="{{trans('admin.manufactory_logo')}}">
            </div>
            <div class="col-3">
                <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> {{trans('admin.create_new_manufactory')}}</button>
              </div>
          </form>
    </div>
    <!-- /.card-body -->
